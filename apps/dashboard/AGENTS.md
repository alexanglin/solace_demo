...
`apps/dashboard/README.md`, ADR-0057, ADR-0058, and the accepted UI-slice ADRs 0089 through 0096.
...
- Run tests with the Node and pnpm versions pinned by ADR-0090 and `package.json`.
