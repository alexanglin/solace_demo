...
`apps/dashboard/README.md`, ADR-0057, ADR-0058, and the accepted UI-slice ADRs 0090 through 0097.
...
- Run tests with the Node and pnpm versions pinned by ADR-0091 and `package.json`.
