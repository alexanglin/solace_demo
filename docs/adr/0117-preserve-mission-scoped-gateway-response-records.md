# ADR-0117: Preserve mission-scoped gateway response records

- **Status:** Superseded by [ADR-0118](0118-separate-gateway-records-from-private-replies.md)
- **Date:** 2026-08-25
- **Deciders:** Alex Anglin
- **Supersedes in part:** ADR-0079, ADR-0114, ADR-0116
...
ADR-0114 and ADR-0116 later classify the fourteen families as eleven notification families, two
...
than `GATEWAY_RESPONSE`, the family alone still determines delivery exactly as ADR-0079 and ADR-0114
