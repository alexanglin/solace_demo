# ADR-0150: Separate mission gateway records from private replies

- **Status:** Accepted
- **Date:** 2026-08-25
- **Deciders:** Alex Anglin
- **Supersedes:** ADR-0149
- **Supersedes in part:** ADR-0068, ADR-0070, ADR-0079, ADR-0146, ADR-0148

## Context

ADR-0149 preserved ADR-0068's useful audit property: every private gateway RPC reply also produces a
...
- **Keep ADR-0149's dual representation and filter the raw reply after receipt.** Rejected because the
