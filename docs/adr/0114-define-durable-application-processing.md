# ADR-0114: Define durable application processing
...
450 MB of nominal reservation. No durable queue is provisioned for `AGENT_RESPONSE`; ADR-0113's exact,
...
ADR-0113's recovery order applies: after a disconnect, a service re-establishes its bindings and drains
