# ADR-0151: Require migrated SQLAlchemy durable tables

- **Status:** Accepted
- **Date:** 2026-08-25
- **Deciders:** Alex Anglin
- **Supersedes:** none; strengthens the persistence mechanism selected by ADR-0003 and ADR-0146

## Context

[ADR-0003](0003-postgres-durable-mission-store.md) selects PostgreSQL, async SQLAlchemy 2.x,
`asyncpg`, and Alembic. [ADR-0146](0146-define-durable-application-processing.md) then names the durable
