...
from sqlalchemy import BigInteger, LargeBinary, String, column, func, insert, select, table, update
...
from aerial_rescue_store.dashboard_runs import DashboardRun, current_run
...
_SOURCE: Final = column("source", String)
_HIGH_WATER: Final = column("high_water_sequence", BigInteger)
_SOURCE_ROWS: Final = table(DASHBOARD_BROKER_SOURCE_TABLE, _SOURCE, _HIGH_WATER)

_EVENT_SOURCE: Final = column("source", String)
_EVENT_ID: Final = column("event_id", String)
_SOURCE_SEQUENCE: Final = column("source_sequence", BigInteger)
_PAYLOAD_DIGEST: Final = column("payload_digest", String)
_AUDIT_MISSION: Final = column("audit_mission_id", String)
_AUDIT_ORDINAL: Final = column("audit_ordinal", BigInteger)
_BROKER_ROWS: Final = table(
    DASHBOARD_BROKER_EVENT_TABLE,
    _EVENT_SOURCE,
    _EVENT_ID,
    _SOURCE_SEQUENCE,
...
_RECORD_MISSION: Final = column("mission_id", String)
_RECORD_ORDINAL: Final = column("ordinal", BigInteger)
_RECORD_KIND: Final = column("kind", String)
_RECORD_PAYLOAD: Final = column("payload", LargeBinary)
_AUDIT_ROWS: Final = table(
    AUDIT_RECORD_TABLE,
    _RECORD_MISSION,
    _RECORD_ORDINAL,
    _RECORD_KIND,
