...
_MISSION_ROWS: Final = DASHBOARD_MISSION
_MISSION_ID: Final = DASHBOARD_MISSION.c.mission_id
_MISSION_SCENARIO: Final = DASHBOARD_MISSION.c.scenario_id
_MISSION_REVISION: Final = DASHBOARD_MISSION.c.scenario_revision
_MISSION_LIFECYCLE: Final = DASHBOARD_MISSION.c.lifecycle
_PREDECESSOR: Final = DASHBOARD_MISSION.c.predecessor_mission_id

_RUN_ROWS: Final = DASHBOARD_RUN
_RUN_IDENTITY: Final = DASHBOARD_RUN.c.run_identity
_RUN_MODE: Final = DASHBOARD_RUN.c.mode
_RUN_SCENARIO: Final = DASHBOARD_RUN.c.scenario_id
_RUN_REVISION: Final = DASHBOARD_RUN.c.scenario_revision
_RUN_MISSION: Final = DASHBOARD_RUN.c.mission_id
_LIVE_RUN: Final = DASHBOARD_RUN.c.run_id
_REPLAY_SESSION: Final = DASHBOARD_RUN.c.session_id
_PREPARED_STATE: Final = DASHBOARD_RUN.c.prepared_initial_state
...
_POINTER_ROWS: Final = DASHBOARD_CURRENT_RUN
_POINTER_KEY: Final = DASHBOARD_CURRENT_RUN.c.singleton_key
_POINTER_RUN: Final = DASHBOARD_CURRENT_RUN.c.run_identity
