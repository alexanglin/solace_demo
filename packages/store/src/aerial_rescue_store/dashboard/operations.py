...
from aerial_rescue_store.database.schema import DASHBOARD_OPERATION
...
_OPERATION_ROWS: Final = DASHBOARD_OPERATION
_KEY: Final = DASHBOARD_OPERATION.c[KEY_COLUMN]
_KIND: Final = DASHBOARD_OPERATION.c.operation_kind
_MODE: Final = DASHBOARD_OPERATION.c.mode
_DIGEST: Final = DASHBOARD_OPERATION.c.request_digest
_SCENARIO: Final = DASHBOARD_OPERATION.c.scenario_id
_SCENARIO_REVISION: Final = DASHBOARD_OPERATION.c.scenario_revision
_MISSION: Final = DASHBOARD_OPERATION.c.mission_id
_RUN: Final = DASHBOARD_OPERATION.c.run_id
_SESSION: Final = DASHBOARD_OPERATION.c.session_id
_PREDECESSOR: Final = DASHBOARD_OPERATION.c.predecessor_mission_id
_STATE: Final = DASHBOARD_OPERATION.c[STATE_COLUMN]
_STATUS: Final = DASHBOARD_OPERATION.c.response_status
_BODY: Final = DASHBOARD_OPERATION.c.response_body
