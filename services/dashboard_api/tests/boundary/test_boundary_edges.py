"""Fail-closed branches for settings, documents, security, and server seams."""
...
from aerial_rescue_dashboard_api.boundary.wire import (
    _calendar_instant,
...
class DocumentBoundaryEdgeTests(unittest.TestCase):
    ...
    def test_non_object_pydantic_dump_is_refused_and_openapi_rejects_body_without_media(
        ...
        with (
            patch(
                "aerial_rescue_dashboard_api.boundary.documents.parse_wire_document",
                return_value=model,
            ),
