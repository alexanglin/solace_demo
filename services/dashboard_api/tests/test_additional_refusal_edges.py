"""Additional fail-closed branches for the dashboard HTTP and orchestration boundaries."""
...
from aerial_rescue_dashboard_api.wire import _strict_literal_one
...
class ApplicationRefusalEdgeTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_canonical_body_helpers_refuse_scalar_documents_non_ascii_keys_and_booleans(
        ...
        # Act
        with (
            patch("aerial_rescue_dashboard_api.application.parse_wire_document"),
