"""Strict boundary-local twins of dashboard and scenario-control wire schemas."""
...
def _require_ordinal_witness(
    latest_audit_ordinal: int,
    latest_event_digest: str | None,
) -> None:
    """Require a checkpoint witness exactly when state accepted an event."""
