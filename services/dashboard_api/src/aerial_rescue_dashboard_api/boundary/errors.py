"""Closed, redacted dashboard HTTP refusal vocabulary and status mapping."""
...
STATUS_BY_CODE: Final = {
    ...
    ErrorCode.MODE_INVALID: 400,
    ErrorCode.PATH_INVALID: 400,
    ...
    ErrorCode.MODE_UNAVAILABLE: 409,
    ErrorCode.MUTATION_REFUSED: 409,
    ErrorCode.NO_CURRENT_RUN: 409,
    ErrorCode.PATH_BODY_MISMATCH: 409,
    ErrorCode.REPLAY_READ_ONLY: 409,
...
MESSAGE_BY_CODE: Final = {
    ...
    ErrorCode.MODE_INVALID: "requested dashboard mode is invalid",
    ErrorCode.MODE_UNAVAILABLE: "requested dashboard mode is unavailable",
    ErrorCode.MUTATION_REFUSED: "dashboard mutation was refused",
    ErrorCode.NOT_READY: "dashboard dependencies are not ready",
    ErrorCode.NO_CURRENT_RUN: "there is no current dashboard run",
    ...
    ErrorCode.PATH_BODY_MISMATCH: "request path does not bind to its body",
    ErrorCode.PATH_INVALID: "request path identifier is invalid",
    ErrorCode.REPLAY_READ_ONLY: "replay mode is read only",
    ErrorCode.REPLAY_SESSION_NOT_FOUND: "replay session was not found",
    ErrorCode.REQUEST_INVALID: "dashboard request is invalid",
    ErrorCode.ROUTE_NOT_FOUND: "dashboard route was not found",
