...
from aerial_rescue_store.migrate import MigrationConfiguration
from aerial_rescue_store.migrate import configuration as store_configuration
...
class ProductionResources:
    """Close the private HTTP pool and database pool once on every application exit."""
