"""FastAPI composition seam for the private dashboard HTTP runtime."""
...
from aerial_rescue_dashboard_api.ingress import (
...
class AuthorizedMutation:
    """Canonical mutation input plus its bearer-derived identity."""
        ...
        body = canonical.canonical_bytes(
            {
                ...
                "runtimeId": self._context.runtime_id,
                "status": "alive",
            }
        )
