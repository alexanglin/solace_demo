"""Policy regressions for mission-control profiles and bounded one-shot services."""
...
class OneShotPolicyTests(QualityGateTestCase):
    def test_migration_may_complete_successfully_without_a_healthcheck(self) -> None:
        # Arrange
    ...
    def test_an_enumerated_one_shot_must_not_restart(self) -> None:
        ...
        # Assert
        self.assertIn('services.migration.restart must be "no" for a one-shot service', findings)
